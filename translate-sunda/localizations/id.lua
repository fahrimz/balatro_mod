return {
    ...
    misc={
        ...
        dictionary={
            ...
            b_collection="Kumpulan",
            b_collection_cap="KUMPULAN",
            b_continue="Teruskeun",
            b_copy="Salin",
            b_copy_seed="Salin Seed",
            b_create_profile="Jieun Profil",
            b_credits="Kiridit",
        ...
        tutorial={
            ...
            s_9={
                "Lamun maneh nabung cukup,",
                "maneh bisa meuli {C:attention}Pocer{}.",
                "{C:attention}Pocer{} bakal otomatis",
                "ningkatkeun permaenan maneh!",
            },
            sb_1={
                "Halo! Ngaran urang",
                "{C:attention}Jimbo{}, urang di dieu bakal",
                "ngabantuan maneh maen!",
            },
            sb_2={
                "Tujuan maneh nya éta meunang",
                "{C:blue}Chips{} jang ngelehkeun",
                "Taruhan {C:attention}musuh",
            },
            sb_3={
                "Ieu téh {C:blue}Taruhan Leutik{},",
                "maneh ngan perlu meunang",
                "{C:attention}300 Chips{} jang ngelehkeun.",
            },
            sb_4={
                "Pilih {C:blue}Penutup Leutik",
                "jang ngamulai babak!",
            },
            sh_1={
                "Lamun maneh meunang leuwih loba kartu,",
                "ulah poho maneh teh bisa ngatur",
                "susunanana. {C:attention}Jokers{} aktip",
                "ti kiri ka kanan",
            },
            sh_2={
                "Jeung pastikeun maneh",
                "{C:attention}MAKE{} barang nu bisa dipake!",
            },
            sh_3={
                "Pilih maksimal {C:attention}2{} kartu",
                "tina leungeun maneh jeung pencét",
                "{C:attention}'PAKE'{} dina kartu {C:tarot}Tarot{}",
                "jang ningkatkeun kartu!",
            },
            sh_3_touch={
                "Pilih maksimal {C:attention}2{} kartu",
                "tina leungeun maneh jeung sered",
                "kartu {C:tarot}Tarot{} kana {C:attention}'PAKE'{}",
                "area jang ningkatkeun kartu!",
            },
        },
        v_dictionary={
            a_chips="+#1#",
            a_chips_minus="-#1#",
            a_hands="+#1# Kartu",
            a_handsize="+#1# Jumlah Kartu",
            a_handsize_minus="-#1# Jumlah Kartu",
            a_mult="+#1# Mult",
            a_mult_minus="-#1# Mult",
            a_remaining="#1# Sésa",
            a_sold_tally="#1#/#2# Dijual",
            a_xmult="X#1# Mult",
            a_xmult_minus="-X#1# Mult",
            ante_x_voucher="ANTE #1# VOUCHER",
            challenges_completed="Beres #1#/#2# Tangtangan",
            completed="#1#/#2# Beres",
            deck_preview_wheel_plural="Nomer bisa kurang pedah aya #1# kartu anu ditarik tibalik",
            deck_preview_wheel_singular="Nomer bisa kurang pedah aya #1# kartu anu ditarik tibalik",
            interest="#1# bunga per $#2# (#3# maks)",
            loyalty_active="Aktip!",
            loyalty_inactive="#1# sésa",
            ml_foil_desc={
                "Foil",
                "+#1# Chips",
            },
            ...
            remaining_discard_money="Sésa Piceunan ($#1# per hiji)",
            remaining_hand_money="Sésa Kartu ($#1# per hiji)",
            unlocked="#1#/#2# Kabuka",
        },
        v_text={
            ch_c_all_eternal={
                "Kabeh Joker jadi {C:eternal}Abadi{}",
            },
            ch_c_chips_dollar_cap={
                "{C:blue}Chips{} teu bisa ngaleuwihan {C:money}$",
            },
            ch_c_daily={
                "{E:1,s:1.2,C:red}Tangtangan Poéan!",
            },
            ch_c_debuff_played_cards={
                "Kabeh kartu {C:attention}anu dipaenkeun{} jadi {C:attention}lemah{} saenggeus nyekor",
            },
            ch_c_discard_cost={
                "Piceun kartu butuh duit {C:money}$#1#{}",
            },
            ch_c_flipped_cards={
                "{C:green}1 tina #1#{} kartu ditarik tibalik",
            },
            ch_c_inflation={
                "Harga naék {C:money}$1{} unggal meuli",
            },
            ch_c_minus_hand_size_per_X_dollar={
                "Nyepeng {C:red}-1{} kartu pikeun unggal {C:money}$#1#{} anu maneh boga",
            },
            ch_c_no_extra_hand_money={
                "Kartu {C:blue}tambahan{} moal meunang duit deui",
            },
            ch_c_no_interest={
                "Moal meunang {C:attention}Bunga{} di ahir babak",
            },
            ch_c_no_reward={
                "Kabeh {C:attention}Blinds{} moal mere duit hadiah",
            },
            ch_c_no_reward_specific={
                "{C:attention}#1# Blinds{} moal mere duit hadiah",
            },
            ch_c_no_shop_jokers={
                "Joker moal bijil di {C:attention}toko",
            },
            ch_c_none={
                "{C:inactive}Kosong",
            },
            ch_c_set_eternal_ante={
                "Lamun ante {C:attention}#1#{} bos dielehkeun, kabeh Joker bakal {C:attention}abadi",
            },
            ch_c_set_joker_slots_ante={
                "Lamun ante {C:attention}#1#{} bos dielehkeun, slot Joker jadi {C:attention}0",
            },
            ch_c_set_seed={
                "1 kasempetan make Seed: {C:inactive}{Hidden}",
            },
            ch_m_consumable_slots={
                "{C:attention}#1#{} Slot Barang Sakali Pake",
            },
            ch_m_discards={
                "{C:red}#1#{} piceun per babak",
            },
            ch_m_dollars={
                "Mimitian make {C:money}$#1#",
            },
            ch_m_hand_size={
                "{C:attention}#1#{} jumlah kartu",
            },
            ch_m_hands={
                "{C:blue}#1#{} kartu per babak",
            },
            ch_m_joker_slots={
